...
FROM
    read_csv_auto('C:/Users/rkp/Desktop/MASAI Prerequisite/Assignment 2/assignment-01-bitsom_ba_2511032/datasets/customers.csv')                   AS c
LEFT JOIN
    read_json_auto('C:/Users/rkp/Desktop/MASAI Prerequisite/Assignment 2/assignment-01-bitsom_ba_2511032/datasets/orders.json')                    AS o
...
JOIN
    ...
    ON c.customer_id = o.customer_id
CROSS JOIN
    read_parquet('C:/Users/rkp/Desktop/MASAI Prerequisite/Assignment 2/assignment-01-bitsom_ba_2511032/datasets/products.parquet')   AS p
WHERE
    ...
    p.unit_price <= o.total_amount          -- only products affordable within order value
ORDER BY
